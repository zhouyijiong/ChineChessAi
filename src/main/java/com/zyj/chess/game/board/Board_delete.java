...
public final class Board_delete {
    public final long[] board;

    public final long[] divisor;

    public static Board_delete init() {
        return new Board_delete(new long[]{0, 8010203040504030201L,
    ...
    public Board_delete(long[] board, long[] divisor) {
        this.board = board;
